...
Vue.component('babelfish-fieldtype', __webpack_require__(4));
Vue.component('babelfish-source-fieldtype', __webpack_require__(9));
...
if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
  console.warn("[vue-loader] Babelfish/resources/assets/src/js/BabelfishFieldtype.vue: named exports in *.vue files are ignored.")}
...
if (false) {(function () {  module.hot.accept()
  ...
  var id = "_v-d4329bd2/BabelfishFieldtype.vue"
  if (!module.hot.data) {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js!../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./BabelfishFieldtype.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js!../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./BabelfishFieldtype.vue");
...
// module
exports.push([module.i, "\n\n\n\n\n\n.babelfish-fieldtype>.field-inner>label {\n    display: none !important;\n}\n\n.babelfish-fieldtype,\n.babelfish-fieldtype .publish-fields {\n    padding: 0 !important;\n}\n", ""]);
...
// <template>
// <publish-fields :fields="fields" :data.sync="data" :regular-title-field="true"></publish-fields>
// </template>
//
//
// <style>
...
if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
  console.warn("[vue-loader] Babelfish/resources/assets/src/js/SourceFieldtype.vue: named exports in *.vue files are ignored.")}
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), false)
  if (!hotAPI.compatible) return
  var id = "_v-804a13b8/SourceFieldtype.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
//         </div>
//
//         <component v-if="source === 'custom'" :is="componentName" :name="name" :data.sync="customText" :config="fieldConfig" :leave-alert="true">
//         </component>
//
    ...
    computed: {
        ...
        suggestConfig: function suggestConfig() {
            return {
                ...
                max_items: 1,
                create: true,
                placeholder: translate('addons.Babelfish::messages.source_suggest_placeholder')
            };
        },
        suggestSuggestions: function suggestSuggestions() {
            var _this = this;

            return Babelfish.fieldSuggestions.filter(function (item) {
